...
// Assignment 18
let places: string[] = ["Aurora-Light-Norway", "St-Mortiz", "Manaco", "Las-Vegas", "LosAngeles"];
...
// Assignment 39
function city_name(cities:string, countrys:string) {
...
function show_magican(magicans_name:string[]) {
...
// Assignment 42
function make_great(show_magican:string) {
...
const magicianNames: string[] = ["David Copperfield", "Criss Angel", "Dynamo"];
...
function order_sandwich(order:string) {
...
// Assignment 45
function abouts_Car(manufacturer:string, modelName:string, optionalFeature:string) {
    let about_Car = {
